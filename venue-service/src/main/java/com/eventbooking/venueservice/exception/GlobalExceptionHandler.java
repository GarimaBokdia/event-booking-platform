...
import com.eventbooking.venueservice.model.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleVenueNotFound(VenueNotFoundException ex, HttpServletRequest request) {
        log.warn("❌ Venue not found: {}", ex.getMessage());
        return buildErrorResponse(HttpStatus.NOT_FOUND, "VENUE_NOT_FOUND", ex.getMessage(), request);
    }
